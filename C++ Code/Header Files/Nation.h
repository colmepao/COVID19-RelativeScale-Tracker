...
public:
	...
	void CompareCountiesAvg(County& county1, County& county2, int startMonth, int endMonth, int endDay);
	void CompareStatesAvg(State& state1, State& state2, int startMonth, int endMonth, int endDay);
};
